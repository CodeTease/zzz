...
To easily install `zzs` and receive future updates naturally through your system's package manager, run the relevant setup script for your environment.
...
```bash
curl -LO https://github.com/CodeTease/zzz/releases/download/v0.3.0/zzs-0.3.0-archlinux-pkgbuild.tar.gz
tar -xzf zzs-0.3.0-archlinux-pkgbuild.tar.gz
makepkg -si
```
...
Install-Package zzs -Source 'codetease/tools'
# Or
Install-Module zzs -Repository 'codetease/tools'
```
...
scoop install scoop-bucket/zzs
```
